...
_GIVEN_NAMES = frozenset({
    ...
    "анатолий", "анжела", "анжелика", "андрей", "анна", "антон", "арина",
    ...
    "галина", "геннадий", "георгий", "глеб", "григорий",
    "даниил", "данил", "данила", "дарья", "демид", "денис", "диана", "дмитрий",
    "евгений", "евгения", "егор", "екатерина", "елена", "елизавета", "ефим",
    "жанна", "захар", "зинаида", "зоя",
    "иван", "игорь", "илья", "инна", "ирина",
    "карина", "кирилл", "клавдия", "константин", "ксения",
    "лариса", "лев", "леонид", "лидия", "лилия", "любовь", "людмила",
    "максим", "маргарита", "марина", "мария", "матвей", "милана", "михаил",
    "надежда", "наталья", "наталия", "никита", "николай", "нина",
    "оксана", "олег", "ольга",
    "павел", "пётр", "петр", "платон", "полина",
    "раиса", "регина", "роман", "руслан",
    "светлана", "святослав", "семен", "семён", "сергей", "софия", "софья",
    "станислав", "степан",
    "тамара", "татьяна", "тимофей", "тимур",
    "ульяна",
    "фаина", "фёдор", "федор", "филипп",
    "эдуард", "эльвира", "эмилия",
    "юлия", "юрий",
    "яков", "яна", "ярослав", "ярослава",
    # clear diminutives / short forms
    "саша", "саня", "шура", "лёша", "леша", "лёня", "леня", "дима", "миша",
    "коля", "костя", "вася", "петя", "вова", "женя", "света", "катя", "настя",
    "оля", "таня", "юля", "даша", "маша", "паша", "гоша", "гриша", "толя",
    "витя", "слава", "ксюша", "ира",
})
...
_SURNAME_SUFFIXES: Tuple[str, ...] = (
    ...
    "овская", "евская", "инская", "ынская",
    "цкий", "цкая", "ский", "ская",
    "енко", "ченко", "ёнок", "енок",
    "ова", "ева", "ёва", "ина", "ына",
    "ов", "ев", "ёв", "ин", "ын",
    "ук", "юк", "як",
    "ян", "дзе", "швили",
